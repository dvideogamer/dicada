...
import com.derek.serializers.DayNameSetDeserializer;
import com.derek.serializers.NameSetSerializer;
...
import static com.derek.model.RecurringIncome.TABLE_NAME;
...
public class RecurringIncome extends AbstractModel {

    /** The ID database column name. */
    public static final String FIELD_ID = "RECURRING_INCOME_ID";

    /** The database table name. */
    public static final String TABLE_NAME = "RECURRING_INCOME";

    /** The database link table name. */
    public static final String DAYS_LINK_TABLE = "RECURRING_INCOME_DAYS";

    /** serialVersionUID. */
    private static final long serialVersionUID = 7726322801376731280L;
